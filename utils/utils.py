...
class Utils:
    def __init__(self):
        ...
        self.log_file_object = open("prediction_log/utils_handler.txt", 'a+')
    ...
    def blur_background(self, mask, frame):
        ...
        """
        try:
            self.logger.log(self.log_file_object, "Blurring the background", "Info")
    ...
    def remove_background(self, mask, frame):
        ...
        """
        try:
            self.logger.log(self.log_file_object, f"Removing the background.", "Info")
    ...
    def change_background(self, mask, frame, path):
        ...
        """
        try:
            self.logger.log(self.log_file_object, "Changing the background", "Info")
